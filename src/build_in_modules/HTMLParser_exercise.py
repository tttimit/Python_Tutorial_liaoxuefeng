...
class MyHTMLParser2(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if self.in_ul:
            if tag == 'li':
                self.temp_data = dict()
            elif self.last_tag == 'h3' and tag == 'a':
                self.key_word = 'event-title'
            elif tag == 'span' and attrs[0][1] == 'event-location':
                self.key_word = 'event-location'
            elif self.last_tag == 'p' and tag == 'time':
                self.key_word = 'event-time'
        self.last_tag = tag
        # print("now key:%s" % self.key_word)

    def handle_data(self, data):
        # print('current key:>%s< data:>%s<' % (self.key_word, data))
        if not self.in_ul:
            return
        if self.temp_data is None:
            return
        data = data.strip('\n ')
        if self.key_word != '' and data != '':
            if self.key_word not in self.temp_data.keys():
                self.temp_data[self.key_word] = data
            else:
                self.temp_data[self.key_word] += data
    ...
    def handle_endtag(self, tag):
        if tag == 'ul':
            self.in_ul = False
        elif self.in_ul and tag == 'li' and self.temp_data:
            self.event_list.append(self.temp_data)
            self.temp_data = None
...
<time datetime="2016-08-23T00:00:00+00:00">23 Aug. &ndash; 28 Aug. <span class="say-no-more"> 2016</span></time>
                    ...
                    <li>
                        <h3 class="event-title"><a href="/events/python-events/425/">PyCon MY 2016</a></h3>
                        <p>


<time datetime="2016-08-26T00:00:00+00:00">26 Aug. &ndash; 29 Aug. <span class="say-no-more"> 2016</span></time>




                            <span class="event-location">City Campus of the International University of Malaya-Wales (IUMW), Kuala Lumpur, Malaysia</span>

                        </p>
                    </li>

                    <li>
                        <h3 class="event-title"><a href="/events/python-events/402/">Kiwi PyCon 2016</a></h3>
                        <p>


<time datetime="2016-09-09T00:00:00+00:00">09 Sept. &ndash; 14 Sept. <span class="say-no-more"> 2016</span></time>




                            <span class="event-location">Dunedin, New Zealand</span>

                        </p>
                    </li>

                    <li>
                        <h3 class="event-title"><a href="/events/python-events/352/">Python Unconference 2016</a></h3>
                        <p>


<time datetime="2016-09-09T00:00:00+00:00">09 Sept. &ndash; 12 Sept. <span class="say-no-more"> 2016</span></time>




                            <span class="event-location">Hamburg, Germany</span>

                        </p>
                    </li>

                    <li>
                        <h3 class="event-title"><a href="/events/python-events/445/">PyData Carolinas 2016</a></h3>
                        <p>


<time datetime="2016-09-14T00:00:00+00:00">14 Sept. &ndash; 17 Sept. <span class="say-no-more"> 2016</span></time>




                            <span class="event-location">IBM RTP Activity Center, 3039 East Cornwallis Road, Building 400, Research Triangle, NC 27709, USA</span>

                        </p>
                    </li>

                    <li>
                        <h3 class="event-title"><a href="/events/python-events/441/">PyCon UK 2016</a></h3>
                        <p>


<time datetime="2016-09-15T00:00:00+00:00">15 Sept. &ndash; 20 Sept. <span class="say-no-more"> 2016</span></time>




                            <span class="event-location">Cardiff City Hall, Gorsedd Gardens Rd, Cardiff CF10 3ND, UK</span>
...
<time datetime="2016-09-15T00:00:00+00:00">15 Sept. &ndash; 20 Sept. <span class="say-no-more"> 2016</span></time>
            ...
            <ul class="list-recent-events menu">
                ...
                <li>
                    <h3 class="event-title"><a href="/events/python-events/448/">PyDay Piura: Comunidad Python Piura</a></h3>
                    <p>


<time datetime="2016-08-20T00:00:00+00:00">20 Aug. &ndash; 21 Aug. <span class="say-no-more"> 2016</span></time>




                        <span class="event-location">Auditorio del CIT de la Universidad Nacional de Piura, Piura, Peru</span>
...
<time datetime="2016-08-19T01:26:32+00:00">19 Aug. &ndash; 21 Aug. <span class="say-no-more"> 2016</span></time>
...
for i in parser.get_events_list():
    print(i)
